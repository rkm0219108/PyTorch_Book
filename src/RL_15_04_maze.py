...
class Environment:
    ...
    def update_poistion(self, action: int) -> int:
        ...
        if new_poistion < 0 or new_poistion > NODE_COUNT or new_poistion in WALL_NODES:
...
class Agent:
    ...
    def action(self, env: Environment) -> int:
        ...
        while (
            ...
            and len(env.trajectory) >= 4
            and new_poistion == env.trajectory[-2]
            and new_poistion == env.trajectory[-4]
        ):
